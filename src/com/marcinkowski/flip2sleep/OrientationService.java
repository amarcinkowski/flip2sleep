...
import com.appspot.flip2sleep.R;
...
public class OrientationService extends Service implements OrientationListener {
	 ...
	 * 
	 * @see
	 * com.appspot.flip2sleep.OrientationListener#onOrientationChanged(float,
	 * float, float)
	 */
	@Override
	...
	private void prepareNotification() {
		...
		Intent notificationIntent = new Intent(this, OrientationReceiver.class);
	...
	public static void acquireStaticLock(Context context2) {
